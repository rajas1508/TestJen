describe ('My Profile', () =>
{
    ...
    it('Single Flow Detailed Profile', ()=>
    {
    ...
    cy.wait(4000)
    cy.xpath('//*[@id="ui-datepicker-div"]/table/tbody/tr[3]/td[3]/a').click()  //xpath for particular date
    ...
    cy.get('#langname1').clear().type('Marathi')    //Enter Language
    ...
    cy.get('#txt_uannumbr').clear().type('888158731956')    //UAN Number
    ...
    cy.get('li[id$="-7"]').click()  //-1:Business; -2:Selfemployed; -3:ServicePublic; -4:ServicePrivate; -5:Retired; -6:Homemaker; -7:Deceased; -8:Others
    ...
    cy.get('#fmlyaadhar_no1').clear().type('548787457699')  //enter adhar
    ...
    //HIGH SCHOOL
    cy.get('#edunavtabs > :nth-child(1) > .legitRipple').click()
    ...
    cy.wait(2000)
    cy.get('#edudetpg > .panel > :nth-child(2) > :nth-child(2) > .form-group > .select2 > .selection > .select2-selection').click()
    cy.get('li[id$="-1265"]').click()
    ...
    //work experience
    cy.get('#WorkExperienceForm > :nth-child(7) > :nth-child(2) > .btn').click()
    ...
    cy.get('#refname1').clear().type('VISHAL JADHAV')
    cy.get('#refdesgntn1').clear().type('SENIOR SOFTWARE TEST ENGINEER')
    cy.get('#reforgname1').clear().type('MEETCS')
    cy.get('#refmobno1').clear().type('8584645789')
    cy.get('#refemailid1').clear().type('vishal.j@gmail.com')
